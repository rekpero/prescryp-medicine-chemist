...
public class OrderHistoryActivity extends AppCompatActivity {
    private RecyclerView order_history_list;
    private String session_mob;
    private List<OrderReceivedItem> receivedItemsList;
    private TextView completed_order_text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        order_history_list = findViewById(R.id.order_history_list);
        completed_order_text = findViewById(R.id.completed_order_text);
                        ...
                        try {
                            ...
                            if (success.equals("1")){
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    if (order_status.equalsIgnoreCase("Delivered") || order_status.equalsIgnoreCase("Declined")){
                                ...
                                OrderRecievedListAdapter adapter = new OrderRecievedListAdapter(receivedItemsList, OrderHistoryActivity.this);
                                order_history_list.setAdapter(adapter);
                                order_history_list.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
                                order_history_list.setHasFixedSize(true);
