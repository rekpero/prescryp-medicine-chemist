...
public class StoreManagementMedicineAdapter extends RecyclerView.Adapter<StoreManagementMedicineAdapter.ViewHolder>{
    ...
    public StoreManagementMedicineAdapter(List<StoreMedicineItem> listItems, Context context){
