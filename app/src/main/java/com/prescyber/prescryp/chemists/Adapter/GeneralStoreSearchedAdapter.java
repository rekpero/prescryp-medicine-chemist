...
public class GeneralStoreSearchedAdapter extends RecyclerView.Adapter<GeneralStoreSearchedAdapter.ViewHolder>{

    private List<GeneralStoreItem> listItems;
    private Context context;

    public GeneralStoreSearchedAdapter(List<GeneralStoreItem> listItems, Context context){
